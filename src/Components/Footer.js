    ...
    return (
        <footer className="footer-container">
            <div className="footer-div">
                    ...
                    <img src={minilogo} alt="Mini logo" width="90px" />
            

                <div className="footer-column">
                    <div className="links" ><h5>LINKS</h5></div>
                ...
                <div className="footer-column">
                    <div className="links" >   <h5>FOLLOW US</h5></div>
                ...
                <div className="footer-column">
                    <div className="links" >  <h5>COME VISIT US</h5></div>
                    <div className="links">
